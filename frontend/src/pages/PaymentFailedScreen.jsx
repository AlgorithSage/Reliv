...
export default function PaymentFailedScreen() {
 ...
 const reasons = [
 { icon: 'signal', text: 'Weak internet connection' },
 { icon: 'bank', text: 'Bank server timeout' },
 { icon: 'credit_card', text: 'Insufficient funds' },
 { icon: 'lock', text: 'UPI / Card verification failed' },
 ];
