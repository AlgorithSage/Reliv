...
export default function WelcomeScreen() {
 ...
 {[
 { name: 'Rahul', streak: '23 days', medal: 'gold_medal', bg: 'linear-gradient(135deg, #FFFBF0 0%, #FFF4DC 100%)', border: '#FFE4A8', glow: 'rgba(255, 200, 100, 0.4)' },
 { name: 'Priya', streak: '19 days', medal: 'silver_medal', bg: 'linear-gradient(135deg, #FAFAFA 0%, #F5F5F5 100%)', border: '#E8E8E8', glow: 'rgba(200, 200, 200, 0.3)' },
 { name: 'Amit', streak: '15 days', medal: 'bronze_medal', bg: 'linear-gradient(135deg, #FFF8F4 0%, #FFEDE4 100%)', border: '#FFDCC8', glow: 'rgba(255, 180, 140, 0.3)' },
 ].map((user, i) => (
 <div
 key={i}
 style={{
