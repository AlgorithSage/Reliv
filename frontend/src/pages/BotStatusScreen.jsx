...
export default function BotStatusScreen() {
 ...
 const faceMap = { robot: '<Icon name="robot" size={18} />', cat: '<Icon name="cat" size={18} />', dog: '<Icon name="dog" size={18} />', panda: '<Icon name="panda" size={18} />', bunny: '<Icon name="bunny" size={18} />', bear: '<Icon name="bear" size={18} />' };
 const soundMap = { chime: '<Icon name="bell" size={18} /> Chime', melody: '<Icon name="music_note" size={18} /> Melody', beep: '<Icon name="pager" size={18} /> Beep', voice: '<Icon name="speaking_head" size={18} /> Voice' };
 const personalityMap = { cheerful: '<Icon name="grin" size={18} /> Cheerful', calm: '<Icon name="relieved" size={18} /> Calm', strict: '<Icon name="frustrated" size={18} /> Strict' };
 ...
 {/* Current Settings */}
 <div style={{ ...glassCard, padding: '24px' }}><h3 style={{ fontSize: 15, fontWeight: 800, color: 'rgba(255,255,255,0.9)', marginBottom: 18 }}> Current Settings</h3>
