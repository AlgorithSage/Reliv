...
export default function FormCheckScreen() {
 ...
 <span style={{ fontSize: 13, fontWeight: 700, color: '#065F46' }}> Meals — {progress.meals.percent}%</span>
 ...
 <div><div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
 ...
 border: '1px solid rgba(240,105,34,0.12)', boxShadow: '6px 6px 16px rgba(0,0,0,0.1), -6px -6px 16px rgba(255,255,255,0.6)',
 }}><h3 style={{ fontSize: 13, fontWeight: 800, color: '#9A3412', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 6 }}>
 What Needs Work
 </h3>
 <div>
 <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
 <span style={{ fontSize: 13, fontWeight: 700, color: '#9A3412' }}> Workouts — {progress.workouts.percent}%</span>
