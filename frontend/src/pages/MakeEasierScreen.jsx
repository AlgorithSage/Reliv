...
export default function MakeEasierScreen() {
 ...
 const suggestions = [
 { icon: 'water_drop', label: 'Water', current: '5/day', suggested: '3/day', color: '#3B82F6' },
 { icon: 'plate_cutlery', label: 'Meals', current: '3/day', suggested: '2/day', color: '#22C55E' },
 { icon: 'weightlifting', label: 'Workouts', current: '5/week', suggested: '3/week', color: '#F06922' },
 ];
 ...
 <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: '#F59E0B', fontWeight: 700, marginBottom: 28 }}>Small wins build habits! <Icon name="plant" size={18} /></p>
        ...
        }}><Icon name="weightlifting" size={18} /><Icon name="plate_cutlery" size={18} /><Icon name="water_drop" size={18} />
            ...
            {Object.entries(progress).map(([key, data]) => (
              <div key={key} style={{
                ...
                <span style={{ fontSize: 13, color: '#666' }}>
                  {key === 'water' ? '' : key === 'meals' ? '' : ''} {key.charAt(0).toUpperCase() + key.slice(1)}
                </span>
                <span style={{
