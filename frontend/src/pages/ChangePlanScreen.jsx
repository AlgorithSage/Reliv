...
export default function ChangePlanScreen() {
 ...
 const plans = [
 { id: 'solo', label: 'Solo', price: '₹29/week', desc: 'Personal plan with daily tracking', icon: 'yoga', path: '/weekly-solo-pay', color: '#3B82F6', gradient: 'linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%)' },
 { id: 'couple', label: 'Couple', price: '₹54/week', desc: 'Track together with your partner', icon: 'couple_heart', path: '/couple-phone', color: '#EC4899', gradient: 'linear-gradient(135deg, #FDF2F8 0%, #FCE7F3 100%)' },
 { id: 'friends', label: 'Friends', price: '₹49+/week', desc: 'Group wellness with friends', icon: 'users_group', path: '/friend-size', color: '#8B5CF6', gradient: 'linear-gradient(135deg, #F5F3FF 0%, #EDE9FE 100%)' },
 { id: 'daily', label: 'Daily', price: '₹7-13/day', desc: 'Day-by-day with fan quiz', icon: 'lightning', path: '/fan-quiz-type', color: '#F59E0B', gradient: 'linear-gradient(135deg, #FFFBEB 0%, #FEF3C7 100%)' },
 ];
