...
export default function WhyTrackingScreen() {
 ...
 const chatMessages = [
 { from: 'bot', text: 'Hey! Did you complete your morning workout?', delay: 0.3 },
 { from: 'user', text: 'YES', delay: 0.7 },
 { from: 'bot', text: 'Awesome! Streak: 1 day! Your bot is doing a happy dance!', delay: 1.1 },
 ];

 const benefits = [
 { icon: 'chart_up', title: 'See Your Progress', desc: 'Watch your habits improve week by week', color: '#3B82F6' },
 { icon: 'robot', title: 'Bot Reacts to You', desc: 'Your IoT bot celebrates your wins!', color: '#8B5CF6' },
 { icon: '⭐', title: 'Earn Stars', desc: 'Complete tasks → earn stars → unlock rewards', color: '#F59E0B' },
 { icon: 'fire', title: 'Build Streaks', desc: 'Don\'t break the chain! Consistency wins.', color: '#EF4444' },
 ];
 ...
 boxShadow: '8px 8px 20px rgba(0,0,0,0.15), -6px -6px 16px rgba(255,255,255,0.4)',
