...
export default function BotOfferScreen() {
 ...
 const features = [
 { icon: 'smile', title: 'OLED Face Display', desc: '6 faces × 3 moods = 18 unique expressions', color: '#F06922' },
 { icon: 'phone', title: 'WhatsApp Sync', desc: 'Real-time sync with your reminders', color: '#25D366' },
 { icon: 'bell', title: 'Smart Reminders', desc: 'Sound + LED when it\'s time to act', color: '#3B82F6' },
 { icon: 'game_controller', title: 'Mini Games', desc: 'Snake, Memory, Reaction Time built-in', color: '#8B5CF6' },
 { icon: 'touch', title: 'Touch Sensor', desc: 'Pet your bot! It responds with love', color: '#EC4899' },
 { icon: 'moon', title: 'Smart Sleep', desc: 'Auto sleeps at night, wakes with you', color: '#6366F1' },
 { icon: '⭐', title: 'Progress System', desc: 'Stars, levels, streaks & unlockables', color: '#F59E0B' },
 { icon: 'brain', title: 'Health Quiz', desc: '15 questions to test your knowledge', color: '#14B8A6' },
 ];
 ...
 <div style={{
      ...
      <div style={{
        ...
        {/* Hero */}
        <div style={{
          background: 'rgba(255,255,255,0.05)', backdropFilter: 'none', WebkitbackdropFilter: 'none',
        ...
        {/* Features */}
        <div style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'none', WebkitbackdropFilter: 'none', borderRadius: 24, padding: '28px', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <div style={{ width: 56, height: 56, borderRadius: 16, background: `${features[activeFeature].color}22`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, flexShrink: 0, boxShadow: `0 8px 24px ${features[activeFeature].color}30` }}><Icon name={features[activeFeature].icon} size={20} /></div>
              <div>
        ...
        <div style={{
          ...
          backdropFilter: 'none', WebkitbackdropFilter: 'none', borderRadius: 24, padding: '32px', textAlign: 'center',
          border: '1px solid rgba(240,105,34,0.2)', boxShadow: '12px 12px 28px rgba(0,0,0,0.15), -10px -10px 24px rgba(255,255,255,0.5), inset 0 1px 0 rgba(255,255,255,0.15)', position: 'relative', overflow: 'hidden',
        }}>
